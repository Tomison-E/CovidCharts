...
class GooeyCarouselState extends State<GooeyCarousel> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _blueImage = Image.asset("assets/images/IMG_9945.PNG");
    _redImage = Image.asset("assets/images/IMG_9921.png");
    _yellowImage = Image.asset('assets/images/IMG_9918.PNG');
    _blueBg = Image.asset(
  ...
  Widget _buildPageIndicator(int index) {
    return Padding(
        ...
        index < 2 ? Expanded(
            ...
            Expanded(
              child: index > 1 ? RaisedButton.icon(onPressed: (){
                Navigator.push(context, CupertinoPageRoute(builder: (context)=>  HomeScreen()));
                },icon: Icon(Icons.fast_forward,color: Color.fromRGBO(245,  89, 37, 1.0)) ,label: Text(" Get Started "),color: Colors.white,textColor: Color.fromRGBO(245,  89, 37, 1.0), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15.0)),):Text(""),
            ),
          ],
        )
    );
